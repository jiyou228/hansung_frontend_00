...
const Home = () => {
  ...
  const goBottom = () =>{
    if(document.getElementById('home_content')){
      document.getElementById('home_content').scrollIntoView({behavior:'smooth', block:'start'})
    }
  };
  return (
    <>
      ...
      <div className='home'>
          <div className='home_head'>
            <div className='home_headTitle'>가장 혁신적인 <br/>취업툴<br/>
          ...
          <div className='home_plus'>
            <h4>Job학다식 +</h4>
            <Link to ='/grammar'><button>맞춤법 검사기</button></Link>

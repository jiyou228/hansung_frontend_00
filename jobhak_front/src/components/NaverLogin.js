...
//       window.location.href = "http://nid.naver.com/oauth2.0/authorize?client_id=JpTJiIlCSBmFu0fI3oft&response_type=code&redirect_uri=https://api.jobhakdasik.site/login/naver";
//     } else {

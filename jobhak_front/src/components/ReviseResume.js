      ...
      const response = await fetch(apiEndpoint, {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content:"사용자가 취업을 위한 자기소개서를 보내면 그것을 좋은 자기소개서로 만들어주는 것이 당신의 역할이다. 한글 기준 공백포함 1000자 이내로 작성하고, 내용을 추가하거나 발전시켜 좋은 인재로 보이게끔 만들어라."           
            },
            {
              role: "user",
              content:

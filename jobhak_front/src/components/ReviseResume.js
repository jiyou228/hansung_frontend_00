...
const Resume = () => {
  ...
  useEffect(() => {
    ...
    if (savedRevision) {
      ...
      setCharCount(savedRevision.length); // 저장된 내용의 글자 수 설정
    }
  }, []);
        ...
        <div className="revise_content">
          <div className="revise_inputarea">
            ...
            <textarea
              ...
              ref={userInputRef}
              onChange={handleInputChange} // 글자 수 업데이트
              required
            />
          </div>

...
# Function
<label for="name" style="color: #0099ff; font-size: 22px; text-align: center; display: block;"> **굵게** Chat GPT를 이용한 자기소개서 생성 및 첨삭 **굵게** </label><br>
![image](https://github.com/JinjinBread/CAPSTONE_04_1/assets/108333554/7cdf6068-4425-4507-baa1-18e18fa121a6)<br>
<label for="name" style="color: #0099ff; font-size: 22px; text-align: center; display: block;"> **굵게** Star GAN을 이용한 사진 합성 **굵게** </label><br>
